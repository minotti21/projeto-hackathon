        ...
        <main className={styles.depoimentosContainer}>
            ...
            <div className={styles.depoimentosFlex}>
                <div>
                    ...
                    <a id="divLink" href='https://letscode.com.br/' target="_blank"><img src="letscode.png" alt="" /></a>
                ...
                <div>
                    ...
                    <h2>Colaboradora.</h2>
                    <a id="divLink" href='https://www.linkedin.com/in/jaque-laurenti-30b15933/' target="_blank"><img src="profJaque.jpg" alt="" /></a>
                ...
                <div>
                    <a id="divLink" href='https://institucional.ifood.com.br/'target="_blank" ><img src="ifood.png" alt="" href="https://institucional.ifood.com.br/" /></a>
                    <h1>Ifood</h1>
